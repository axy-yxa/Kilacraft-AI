 ...
 * PluginLogger.error("模块", "加载失败: {}", errorMsg, exception);
 *
 * // ✅ 正确：先翻译模板，再传入 Throwable 重载
 * PluginLogger.error("模块", I18nService.tr("加载失败: {}", errorMsg), exception);
 *       </pre>
 *   </li>
 * </ul>
 *

...
public class ProfileEventCollector implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        // 仅提交普通登录事件
        eventCollector.submitEvent(ServerEvent.of(ServerEventType.PLAYER_LOGIN, uuid, name));
    ...
    public void onPlayerQuit(PlayerQuitEvent event) {
        ...
        // 记录登出事件
        eventCollector.submitEvent(ServerEvent.of(ServerEventType.PLAYER_LOGOUT, uuid, player.getName()));

...
public class PlayerItemBreakWatchTask extends AFKTask implements Listener {
    ...
    public void onPlayerItemBreak(PlayerItemBreakEvent event) {
        ...
        if (hasCallback) {
            ...
            complete("目标玩家 " + brokenItemPlayerName + " 的物品 " + itemName + " 已损坏，监视任务完成。");
        }
    }
    ...
    private void executeCallback(String triggeredPlayerName, String itemName, String itemType) {
        try {
            ...
            future.thenAccept(result -> {
                ...
                // 8. 完成任务
                complete("目标玩家 " + triggeredPlayerName + " 的物品 " + itemName + " 已损坏，回调任务已执行。");
            }).exceptionally(ex -> {
    ...
    public String getTaskDescription() {
        String desc = "监视玩家 " + targetPlayerName + " 的物品损坏";

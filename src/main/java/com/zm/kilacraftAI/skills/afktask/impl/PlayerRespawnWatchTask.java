 ...
 *   <li>可获取玩家重生的位置坐标</li>
 *   <li>本任务只负责监视重生事件，回调逻辑与上线监视一致</li>
 * </ul>
 *
 * <h3>使用场景：</h3>
 * <ul>
 *   <li>"帮我盯着 Steve，他重生了告诉我"</li>
 *   <li>"监视玩家A，他重生后查询他的位置"</li>
 * </ul>
 *
 * <h3>必需参数：</h3>
 * <ul>
 ...
 * @since 2026-04-10
 */
public class PlayerRespawnWatchTask extends AFKTask implements Listener {
    ...
    public PlayerRespawnWatchTask(String taskId, UUID playerUUID, String playerName, String description, Map<String, String> params) {
        super(taskId, playerUUID, playerName, AFKTaskType.PLAYER_RESPAWN_WATCH, description, params);
     ...
     * 执行回调任务（带坐标信息）
     */
    private void executeCallback(String triggeredPlayerName, Location respawnLocation) {
        try {
            // 1. 构建 TaskPlan
            TaskPlan plan = callback.getCallbackTask().toTaskPlan();
            replacePlaceholdersInTaskPlan(plan, triggeredPlayerName, respawnLocation);

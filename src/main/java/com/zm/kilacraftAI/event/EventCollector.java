...
public class EventCollector implements Listener {
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_DEATH, event.getEntity().getUniqueId(), event.getDeathMessage()));
    }
    ...
    public void onAdvancement(PlayerAdvancementDoneEvent event) {
        ...
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_ADVANCEMENT, event.getPlayer().getUniqueId(), advancementKey));
    }
    ...
    public void onTotemUse(EntityResurrectEvent event) {
        ...
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_USE_TOTEM, player.getUniqueId(), cause));
    }
    ...
    public void onBossKill(EntityDeathEvent event) {
        ...
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_DEFEAT_BOSS, killer.getUniqueId(), type.name()));
    }
    ...
    public void onPetDeath(EntityDeathEvent event) {
        ...
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_PET_DEATH, owner.getUniqueId(), data.toString()));
    }
    ...
    public void onToolBreak(PlayerItemBreakEvent event) {
        ...
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_TOOL_BREAK, event.getPlayer().getUniqueId(), type.name()));
    }
    ...
    public void onFishTreasure(PlayerFishEvent event) {
        ...
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_CATCH_TREASURE, event.getPlayer().getUniqueId(), type.name()));
    }
    ...
    public void onLightningStrike(EntityDamageEvent event) {
        ...
        submitEvent(ServerEvent.of(ServerEventType.PLAYER_LIGHTNING_STRIKE, player.getUniqueId(), ""));
    }

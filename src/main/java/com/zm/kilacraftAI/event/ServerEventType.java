...
public enum ServerEventType {
    ...
    // 好友动态
    PLAYER_USE_TOTEM("触发不死图腾"), PLAYER_DEFEAT_BOSS("击杀BOSS"), PLAYER_COMPLETE_RAID("完成袭击"), PLAYER_PET_DEATH("宠物死亡"), PLAYER_PVP_KILL("PVP击杀"), PLAYER_TOOL_BREAK("工具断裂"), PLAYER_CATCH_TREASURE("钓到宝藏"), PLAYER_LIGHTNING_STRIKE("被雷劈"), PLAYER_CURE_VILLAGER("治愈僵尸村民");

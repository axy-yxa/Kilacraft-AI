...
public class ServerEvent {
     ...
     * 创建事件（无目标玩家）
     */
    public static ServerEvent of(ServerEventType type, UUID playerUuid, String data) {
     ...
     * 创建事件（有目标玩家）
     */
    public static ServerEvent of(ServerEventType type, UUID playerUuid, UUID targetUuid, String data) {

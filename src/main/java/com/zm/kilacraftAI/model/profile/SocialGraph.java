...
public class SocialGraph {
    ...
    private volatile SocialRelationDao socialDao;
    ...
    public void refreshConfig() {
        ...
        this.socialDao = new SocialRelationDao(prefix);
    ...
    public int performDailyDecay() {
        ...
        try (var conn = databaseManager.getConnection()) {
            ...
            try {
                ...
                if (cleaned > 0) {
                    PluginLoggerUtil.info("数据库", "社交关系衰减完成，清理 {} 条弱关系", cleaned);
                }
            ...
            PluginLoggerUtil.error("数据库", "社交关系衰减失败: {}", e.getMessage());
            return 0;
        }
    }

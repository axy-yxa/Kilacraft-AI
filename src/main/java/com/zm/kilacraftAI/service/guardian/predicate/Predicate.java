 ...
 *
 * <p>稳定性红线：谓词永不走 skill（替代旧 {@code ConditionEvaluator} 的 skill 代理）。
 * 读状态（谓词）走直接 API / 快照；改状态（动作）才走 skill。</p>
 *
 * @author Zm_Mmm
 * @since 2026-07-01
 */
public interface Predicate {
     ...
     * 额外读取的熔炉位置（拉取式，§6.7）。引擎按一玩家一轮的到点 monitor 并集请求，一次 snapshot 喂所有。

    ...
    private Object extractThreadSafeData(Object result, String methodName) {
        ...
        if (result instanceof org.bukkit.inventory.ItemStack itemStack) {
            ...
            if (itemStack.hasItemMeta() && itemStack.getItemMeta().hasDisplayName()) {
                ...
                String chineseName = ItemTranslator.getInstance().translateToChinese(itemStack.getType().name());
                ...
                for (int i = 0; i < contents.length; i++) {
                    ...
                    if (item != null && item.getType() != org.bukkit.Material.AIR) {
                        ...
                        if (item.hasItemMeta() && item.getItemMeta().hasDisplayName()) {
                            ...
                            armorData.put(prefix + "_name", ItemTranslator.getInstance().translateToChinese(item.getType().name()));
                        }
                ...
                for (int i = 0; i < contents.length; i++) {
                    ...
                    if (item != null && item.getType() != org.bukkit.Material.AIR) {
                        ...
                        if (item.hasItemMeta() && item.getItemMeta().hasDisplayName()) {
                            ...
                            itemData.put("item_name", ItemTranslator.getInstance().translateToChinese(item.getType().name()));
                        }

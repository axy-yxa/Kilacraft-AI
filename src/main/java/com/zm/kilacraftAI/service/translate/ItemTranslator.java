package com.zm.kilacraftAI.service.translate;
...
public class ItemTranslator {
    ...
    public void loadTranslationTable() {
        ...
        try {
            ...
            if (inputStream == null) {
                PluginLoggerUtil.error("物品翻译", "无法找到 internal/translate/items_CN.yml 文件");
                return;
            }
            ...
            PluginLoggerUtil.info("物品翻译", "已加载 {} 个物品翻译", count);
            loaded = true;

        } catch (Exception e) {
            PluginLoggerUtil.error("物品翻译", I18nService.tr("加载物品翻译表失败: {}", e.getMessage()), e);
        }
    }

> ⚠️ **归档文档（v2.2.0）**
>
> 本文档描述的 19 个 Bukkit Event 监听器（属于已移除的挂机任务系统）已于 v2.2.0 整体移除。
>
> 当前的事件监听能力由 **WatchSkill**（玩家自定义监听）提供，支持 11 种高价值事件监听（熔炉烧好/作物成熟/实体死亡/生成/玩家死亡/传送/升级/换世界/方块破坏/钓鱼/聊天）。详见《内置 Skill 与 Event 能力清单》。
>
> 本文档仅作历史参考保留，正文不再维护。
...
> **最后更新**: 2026-05-06  
> **说明**: 本文档提供所有已实现的 Bukkit Event 监听器（AFK 挂机任务）的详细说明、配置示例和使用场景（**已归档，监听器已移除**）
